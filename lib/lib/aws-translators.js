(function() {
  ...
  module.exports.scanPaged = function(params, options, callback, keySchema) {
    var awsParams, awsValue, key, value, _ref;
    if (params == null) {
      params = {};
    }
    awsParams = {
  ...
  module.exports.updateItem = function(params, obj, options, callback, keySchema) {
    var awsParams, calcUpdateExpression, expressionAttributeNames, expressionAttributeValues, i, key, updateExpression, _i, _len, _ref;
    key = getKey(params, keySchema);
